...
def primePairSets(a_0,b_0,c_0,d_0,e_0):
    for a in primeCheck.primes(a_0):
        for b in primeCheck.primes(b_0,a+1):
            for c in primeCheck.primes(c_0,b+1):
                for d in primeCheck.primes(d_0,c+1):
                    for e in primeCheck.primes(e_0,d+1):
                        ...
                        for i in p_list:
                            ...
                            allPrime = allPrime and primeCheck.isPrime(int(prime_str))
                        if allPrime:
                            return(primes_list)
